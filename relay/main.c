...
#define GPIO_RELAY      GPIO_NUM_5
#define GPIO_SEL_PIN    1ULL<<GPIO_RELAY

#define WIFI_SSID       "Hotspot-ASUS"
#define WIFI_PASS       "12101999"
    ...
    switch (event->event_id) {
        ...
        case MQTT_EVENT_DATA:
            ...
            if (strcmp(_topic, "hotel/" ROOM_NUM "/admin") == 0) {
                ...
                (admin_ctrl && (human_cnt > 0)) ? gpio_set_level(GPIO_RELAY, 0) : gpio_set_level(GPIO_RELAY, 1);
                printf("Count: %d\n", human_cnt);
            }
            break;
